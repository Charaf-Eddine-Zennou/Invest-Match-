...
class SignupStep5ParamEntreprise extends StatefulWidget {
  ...
  const SignupStep5ParamEntreprise({
    super.key,
  ...
  @override
  State<SignupStep5ParamEntreprise> createState() => _SignupStep5ParamEntreprise();
}

class _SignupStep5ParamEntreprise extends State<SignupStep5ParamEntreprise> {
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      onChanged: (val) => setState(() => companyName = val.trim()),
                    ...
                    TextFormField(
                      ...
                      onChanged: (val) => setState(() => siret = val.trim()),
                      validator: (val) => val == null || val.isEmpty ? "Obligatoire" : null,
                    ),
                    const SizedBox(height: 16),
                    ...
                    TextFormField(
                      ...
                      onChanged: (val) => setState(() => address = val.trim()),
                      validator: (val) => val == null || val.isEmpty ? "Obligatoire" : null,
                    ),
                    const SizedBox(height: 16),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: allSectors
                          ...
                          .toList(),
                      value: domaine.isNotEmpty ? domaine : null,
                      onChanged: (val) => setState(() => domaine = val ?? ""),
                      validator: (val) => val == null || val.isEmpty ? "Obligatoire" : null,
                    ),
                  ],
                ),
